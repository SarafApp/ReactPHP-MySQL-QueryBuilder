...
// UPDATE Customers SET ContactName = 'Alfred Schmidt' WHERE CustomerID BETWEEN 10 AND 20;
$dbFactory->getQueryBuilder()
    ->update()
    ->table("Customers")
    ->setUpdate('ContactName', 'Alfred Schmidt')
    ->whereNotBetween("CustomerID", 10, 20)
    ->compile()
    ->getQuery()
    ->then(function ($result) {
        echo "Excepted: UPDATE Customers SET ContactName = 'Alfred Schmidt' WHERE CustomerID NOT BETWEEN 10 AND 20" . PHP_EOL;
        echo "Actual:   " . $result['query'] . PHP_EOL . PHP_EOL;
    });
